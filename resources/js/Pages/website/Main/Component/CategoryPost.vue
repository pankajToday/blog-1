                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-1.jpg')" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-2.jpg')" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
            ...
            <div class="row">
                <div class="col-md-9 order-md-2">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-5.jpg')" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="#">11 Work From Home Part-Time Jobs You Can Do Now</a></h2>
                                <span class="author mb-3 d-block">Jenny Wilson</span>
                                <p class="mb-4 d-block">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero temporibus repudiandae, inventore pariatur numquam cumque possimus</p>
                        ...
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-7.jpg')" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Business</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="#">How to Avoid Distraction and Stay Focused During Video Calls?</a></h2>
                                <span class="author mb-3 d-block">Jenny Wilson</span>
                                <p class="mb-4 d-block">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero temporibus repudiandae, inventore pariatur numquam cumque possimus</p>
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="#"><img :src="asset('zenBlog/img/post-landscape-8.jpg')" alt="" class="img-fluid"></a>
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-6.jpg')" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-4.jpg')" alt="" class="img-fluid"></a>
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-3.jpg')" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2><a href="#">6 Easy Steps To Create Your Own Cute Merch For Instagram</a></h2>
                            </div>
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-2.jpg')" alt="imh" class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="#"><img :src="asset('zenBlog/img/post-landscape-1.jpg')" alt="umh" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
